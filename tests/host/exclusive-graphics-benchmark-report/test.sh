...
/usr/bin/sed '33s/sprite_dma=inactive/sprite_dma=active/' \
...
/usr/bin/sed '33s/actual_checksum=123456/actual_checksum=654321/' \
...
/usr/bin/sed '33s/maximum_ticks=1020/maximum_ticks=2000000/' \
