...
source language, stack arguments, varargs, general runtime-service IDs, and
ordinary calls remain unavailable and require an explicit compatible extension
or ABI version bump before compiler code may emit them.
